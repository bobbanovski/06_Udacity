...
CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL, start_time timestamp NOT NULL, user_id int NOT NULL, 
level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar, PRIMARY KEY (songplay_id))
""")
# Dimension Tables =============================
user_table_create = ("""
...
song_table_create = ("""
CREATE TABLE IF NOT EXISTS songs (song_id varchar, title varchar NOT NULL, artist_id varchar, year int NOT NULL, duration decimal NOT NULL, PRIMARY KEY (song_id))
""")
...
song_select = ("""
    SELECT songs.song_id AS song_id, artists.artist_id AS artist_id FROM songs JOIN artists ON artists.artist_id = songs.artist_id 
